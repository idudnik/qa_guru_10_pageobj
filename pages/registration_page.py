...
from qa_guru_10_test.resources import path
...
class RegistationPage:
    ...
    def should_include_info(self,full_name,email,gender,mobile,date_of_bitrth, subject,hobbie,picture_name,address,city_and_state):
      browser.all('tbody tr td:last-child').should(have.exact_texts(full_name,email,gender,mobile,date_of_bitrth, subject,hobbie,picture_name,address,city_and_state))
